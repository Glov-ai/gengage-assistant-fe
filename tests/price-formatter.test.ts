...
describe('formatPrice', () => {
  describe('Turkish defaults', () => {
    it('formats whole number with dot thousands separator and no decimals', () => {
  ...
  describe('custom config', () => {
    ...
    it('hides decimals for whole numbers by default', () => {
      expect(formatPrice('100')).toBe('100 TL');
    });

    it('shows decimals for whole numbers when alwaysShowDecimals is true', () => {
